...
public class SeanceCoursMock implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (seanceCours.isEmpty()) {
            ...
            seanceCours3.setHeureDb(LocalTime.of(11, 15));
            seanceCours3.setHeureFin(LocalTime.of(13, 15));
            ...
            seanceCours4.setHeureDb(LocalTime.of(11, 15));
            seanceCours4.setHeureFin(LocalTime.of(15, 15));
