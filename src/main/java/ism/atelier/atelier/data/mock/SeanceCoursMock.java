...
public class SeanceCoursMock implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (seanceCours.isEmpty()) {
            ...
            seanceCours2.setHeureDb(LocalTime.of(13, 27));
            seanceCours2.setHeureFin(LocalTime.of(13, 57));
            ...
            seanceCours3.setHeureFin(LocalTime.of(13, 20));
            ...
            seanceCours4.setHeureDb(LocalTime.of(13, 15));
            seanceCours4.setHeureFin(LocalTime.of(13, 30));
