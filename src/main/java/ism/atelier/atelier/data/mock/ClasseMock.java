...
public class ClasseMock implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (classes.isEmpty()) {
            ...
            classe2.setId("2");
            classe1.setName("L3CDSD");
            classe1.setFiliereId("2");     // 8h00
            classe1.setNiveauId("3");   // 12h00
            classe1.getCoursIds().add("2");
            classe1.getEtudiantIds().add("4");
            classe1.getEtudiantIds().add("5");
            classes.add(classe2);
        }
